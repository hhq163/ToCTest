...
void protobuf_AddDesc_UserLogout_2eproto_impl() {
...
void protobuf_AddDesc_UserLogout_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_UserLogout_2eproto);
}

#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_UserLogout_2eproto_once_);
void protobuf_AddDesc_UserLogout_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_UserLogout_2eproto_once_,
                 &protobuf_AddDesc_UserLogout_2eproto_impl);
}
#else
// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_UserLogout_2eproto {
  StaticDescriptorInitializer_UserLogout_2eproto() {
    protobuf_AddDesc_UserLogout_2eproto();
  }
} static_descriptor_initializer_UserLogout_2eproto_;
#endif

// ===================================================================

#ifndef _MSC_VER
const int UserLogout::kClientTypeFieldNumber;
#endif  // !_MSC_VER

UserLogout::UserLogout()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:yunquan.UserLogout)
}
...
UserLogout::UserLogout(const UserLogout& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:yunquan.UserLogout)
}
...
UserLogout::~UserLogout() {
  // @@protoc_insertion_point(destructor:yunquan.UserLogout)
  SharedDtor();
}
...
const UserLogout& UserLogout::default_instance() {
  ...
  protobuf_AddDesc_UserLogout_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_UserLogout_2eproto();
#endif
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:yunquan.UserLogout)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:yunquan.UserLogout)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:yunquan.UserLogout)
  return false;
#undef DO_
}
...
void UserLogout::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:yunquan.UserLogout)
  // required .yunquan.E_CLIENT_TYPE clientType = 1;
  if (has_clienttype()) {
  ...
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:yunquan.UserLogout)
}
