...
enum CMD {
  ...
  CMD_ACTIVITY_COMMENTS = 769,
  CMD_ACTIVITY_COMMENTS_ACK = 770,
  CMD_ENTER_ACTIVITY_ROOM = 771,
  CMD_ENTER_ACTIVITY_ROOM_ACK = 772,
  CMD_EXIT_ACTIVITY_ROOM = 773,
  CMD_EXIT_ACTIVITY_ROOM_ACK = 774,
...
const SERVER_TYPE SERVER_TYPE_MIN = ST_CONNECT_SVR;
const SERVER_TYPE SERVER_TYPE_MAX = ST_WEB_API;
