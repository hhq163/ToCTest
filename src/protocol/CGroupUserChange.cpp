...
CGroupUserChange::CGroupUserChange() {
...
int CGroupUserChange::Parse(uint8* pBuf, int32& dwSize)
{
    uint8* p = pBuf;
    int32 dwUsedSize = dwSize;
    Logger.Log(INFO, "CGroupUserChange::Parse(in)");
...
//////////////////////////////////////////////////////////////////////////
    ...
    dwSize = (int32)(p - pBuf );
    Logger.Log(ERROR, "CGroupUserChange::Parse(out)");
    return ERR_SUCCESS;

}


int CGroupUserChange::Pack(uint8* pBuf, int32& dwSize)
{
    uint8* p = pBuf;
    int32 dwUsedSize = dwSize;
...
///////////////////////////////////////////////////////////
    ...
    Logger.Log(INFO, "CGroupUserChange::Pack(out)");
